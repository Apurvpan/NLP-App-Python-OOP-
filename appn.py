...
class NLPApp:
    ...
    def __init__(self) -> object:
        ...
        self.dbo = Database()
        self.apio = API()
        # code to show login GUI
        self.root = Tk()
        self.root.title('NLPApp')
        self.root.iconbitmap('Resources/favicon.ico')
        self.root.geometry('350x600')
        self.root.configure(bg='#5499C7')
    ...
    def login_gui(self):
        ...
        heading = Label(self.root, text='NLP App', bg='#5499C7', fg='white')
        ...
        login_btn = Button(self.root,text='Login',width=20,height=2,
    ...
    def sentiment_gui(self):
        ...
        heading = Label(self.root, text='NLPApp',bg='#5499C7',fg='white')
        heading.pack(pady=(30,30))
        heading.configure(font=('verdana',24,'bold'))

        heading2 = Label(self.root, text='Sentiment Analysis', bg='#5499C7', fg='white')
        ...
        self.sentiment_result = Label(self.root, text='',bg ='#5499C7',fg='white')
